...
export default defineConfig({
	...
	// query belongs in the URL. That argument does not reach an event storm. A
	...
	//
	// So React is here for exactly one component, <EventStormBoard client:only>.
	// Every other page in doc-es is still server-rendered HTML with no script
