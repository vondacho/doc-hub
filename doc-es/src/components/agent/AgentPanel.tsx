/**
 * The prompting area: a demand in, an answer beside the wall.
 *
 ...
 * parsing.** The claim this whole tool rests on is that the text is the wall;
		...
		>
			...
			<div className="border-t border-slate-200 p-2 dark:border-slate-700">
				<textarea
					...
					placeholder={`Ask about this event storm, or ask for a change. ⌘/ctrl + ⏎`}
