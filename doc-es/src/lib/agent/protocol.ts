...
export const LANGUAGE = 'eventstorm';

/** What to call it in a sentence the visitor reads. */
export const LANGUAGE_LABEL = 'event storm';
...
export function proposalIn(answer: string): string | null {
	...
	// language named in a sentence — "wrap it in a ```eventstorm block" — is prose.
 ...
 * would flash a wall of `.eventstorm` at somebody who asked a question.
 */
