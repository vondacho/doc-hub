...
const EDITOR_TEXT = 'doc-es:editor-text';
 ...
 * or be listed as one.
 */
const AGENT = 'doc-es:agent';
const AGENT_WIDTH = 'doc-es:agent-width';
const AGENT_CONFIG = 'doc-es:agent-config';
const AGENT_KEY = 'doc-es:agent-key';
