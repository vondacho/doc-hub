...
export const icons = {
	...
	/*
	 * A cucumber, for the feature file.
	 *
	 * The one glyph here that names a *tool* rather than a shape, and the only
	 * one where that is the clearer choice: everybody who will ever press this
	 * row knows what Gherkin runs on, and a picture of a document with "steps"
	 * in it would be indistinguishable from the outline two rows below.
	 */
	gherkin: 'M15.5 4c2 0 3.5 1.2 3.5 3 0 3.5-2 8-5 11S7 21 5.5 19 4 14 7 11s7-7 8.5-7ZM10 15.5h.01M13 12h.01M9 11h.01M14 15h.01',
