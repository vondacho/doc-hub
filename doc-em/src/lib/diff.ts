 ...
 *
 * Lines rather than words or characters. The unit that matters in an
 * `.examplemap` is the line: a rule, an example, a given/when/then. A word diff
 * inside a wrapped `note` would be noise about where the fold landed.
 */
