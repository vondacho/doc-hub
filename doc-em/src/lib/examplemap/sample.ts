 ...
 *
 * What the New button opens, and it opens a map with its story on it rather than the choice of
 ...
 * answered.
 *
 * So it comes with one story, named badly on purpose and waiting to be
