 ...
 * messages, not about rules or examples. It is one of the four modules copied
...
export function formatProblems(problems: readonly Problem[]): string {
	...
	const head = problems.length === 1 ? 'The example map file has a problem:' : `The example map file has ${problems.length} problems:`;
