 ...
 *
 * This module is the reason doc-em is no longer a component that calls nothing.
 ...
 * with it, none of which an example map has an opinion about.
 *
 ...
 * make the honest one.
 *
 * doc-em is in a different position. The registry is not what the page is about;
