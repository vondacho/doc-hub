...
export const LANGUAGE = 'examplemap';

/** What to call it in a sentence the visitor reads. */
export const LANGUAGE_LABEL = 'example map';
...
export function proposalIn(answer: string): string | null {
	...
	// language named in a sentence — "wrap it in a ```examplemap block" — is prose.
 ...
 * would flash a wall of `.examplemap` at somebody who asked a question.
 */
