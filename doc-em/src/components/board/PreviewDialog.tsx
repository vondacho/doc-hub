/**
 * The `.examplemap` file this board would export — readable, and editable.
 *
 ...
 *
 * Unlike doc-sm's preview, no line here is inert: Everything in an example map is text somebody typed, so everything here is
 * editable and applying it replaces the board.
 */
		...
		>
			<div className="flex max-h-[85vh] flex-col">
				...
				<div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1 border-t border-slate-200 px-5 py-3 text-xs text-ink-muted dark:border-slate-700 dark:text-slate-400">
					...
					<p>
						Every line here is editable. Applying replaces the board.
					</p>
				</div>
			</div>
		</dialog>
