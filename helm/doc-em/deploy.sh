#!/usr/bin/env bash
#
# Build, install and verify doc-em on a local cluster.
#
#   ./helm/doc-em/deploy.sh              # build, upgrade, restart, test
#   ./helm/doc-em/deploy.sh --no-build   # skip the image build
#   ./helm/doc-em/deploy.sh --no-test    # skip helm test
#
