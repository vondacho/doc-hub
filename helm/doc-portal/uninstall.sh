#!/usr/bin/env bash
#
# Remove the doc-portal release.
#
#   ./helm/doc-portal/uninstall.sh                 # release only
#   ./helm/doc-portal/uninstall.sh --namespace     # and the namespace with it
#
...
# everything else in it, which will not be doc-portal's to delete once a second
