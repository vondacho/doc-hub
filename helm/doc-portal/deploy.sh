#!/usr/bin/env bash
#
# Build, install and verify doc-portal on a local cluster.
#
#   ./helm/doc-portal/deploy.sh              # build, upgrade, restart, test
#   ./helm/doc-portal/deploy.sh --no-build   # skip the image build
#   ./helm/doc-portal/deploy.sh --no-test    # skip helm test
#
# Environment overrides:
#   NAMESPACE  (default doc-hub)
#   RELEASE    (default doc-portal)
...
SOURCE_DIR="$REPO_ROOT/doc-portal"
