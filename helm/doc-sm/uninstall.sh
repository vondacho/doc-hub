#!/usr/bin/env bash
#
# Remove the doc-sm release.
#
#   ./helm/doc-sm/uninstall.sh                 # release only
#   ./helm/doc-sm/uninstall.sh --namespace     # and the namespace with it
#
...
# everything else in it, which will not be doc-sm's to delete once a second
