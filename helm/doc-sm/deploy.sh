#!/usr/bin/env bash
#
# Build, install and verify doc-sm on a local cluster.
#
#   ./helm/doc-sm/deploy.sh              # build, upgrade, restart, test
#   ./helm/doc-sm/deploy.sh --no-build   # skip the image build
#   ./helm/doc-sm/deploy.sh --no-test    # skip helm test
#
# Environment overrides:
#   NAMESPACE  (default doc-hub)
#   RELEASE    (default doc-sm)
