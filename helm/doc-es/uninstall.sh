#!/usr/bin/env bash
#
# Remove the doc-es release.
#
#   ./helm/doc-es/uninstall.sh                 # release only
#   ./helm/doc-es/uninstall.sh --namespace     # and the namespace with it
#
...
# everything else in it, which will not be doc-es's to delete once a second
