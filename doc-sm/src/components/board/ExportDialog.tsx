 ...
 * the ticket, the `.storymap` is the copy that survives a cleared browser,
...
const GROUPS: readonly { group: Group; title: string; blurb: string | null }[] = [
	{ group: 'map', title: 'This map', blurb: null },
	{
		...
		title: 'The practice',
		blurb:
			'Not about this map. Instructions to hand a coding agent working on a .storymap file somewhere else — the same text this board’s own assistant is given.',
	},
];
