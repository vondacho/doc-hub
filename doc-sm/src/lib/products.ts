 ...
 *
 * This module is the reason doc-sm is no longer a component that calls nothing.
 ...
 * with it, none of which a story map has an opinion about.
 *
 ...
 * make the honest one.
 *
 * doc-sm is in a different position. The registry is not what the page is about;
